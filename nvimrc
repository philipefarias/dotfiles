...
" Reload and edit nvimrc
nnoremap <silent> <LocalLeader>rs :source ~/.nvimrc<CR>
nnoremap <silent> <LocalLeader>rt :tabnew ~/.nvimrc<CR>
nnoremap <silent> <LocalLeader>re :e ~/.nvimrc<CR>
